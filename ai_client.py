...
SYSTEM_PROMPT = (
    ...
    "COHERENCIA: antes de escribir nada, elegí UN detalle ancla concreto (un producto puntual, "
    "un horario, un tipo de consulta) y hacé que TODO el video sea sobre ESE detalle específico: "
    "portada, problema, costo, solución, demo y resultado tienen que referirse al mismo detalle, "
    "no a un problema genérico o a temas distintos entre slides. Misma unidad de tiempo en toda "
    "la pieza (no mezclar 'por semana' con 'al mes'), los números tienen que cerrar "
    "aritméticamente, las 4 slides son una sola historia encadenada sobre ese detalle ancla "
    "(escena del problema -> costo -> qué cambia -> resultado con el mismo número del principio), "
    "y el demo es el mismo caso puntual del que se viene hablando, no uno distinto. "
    "'tiempo_respuesta' siempre inmediato (segundos), nunca minutos ni horas.\n\n"
